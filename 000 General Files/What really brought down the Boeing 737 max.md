...
year published: "2019"
---
- The article builds a story starting to insinuate blame towards Lion Air, an airline local to Indonesia, for their practices of putting in-experienced pilots in the cockpit.
- **Airmanship** - a sense of navigation, weather, weather information, mentally map traffic flows, fluency in radio communication, and an appreciation for the interplay between inertia and wings.
- Anecdote about how the US Navy instills **Airmanship** in pilots, but how airline pilots never really get a chance to fully be comfortable in their plane.
- In the flights failure, the pilot was being undescriptive. 
- Trim seemed to be the cultrate, since this is the mechanism which basically keeps the airplane's noise from going up or down and is manually adjusted by the pilot using a small thumb joy stick. When it doesn't do that, it is runaway trim. 
- There was a simple way to fix that but it doesn't seem that that was used by the pilot.
